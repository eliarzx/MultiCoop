...
$query = "SELECT * FROM SAVINGS_ACCOUNTS ORDER BY deposit_date DESC";
...
<head>
  <meta charset="UTF-8" />
  <title>Savings Accounts Management</title>
...
<a href="#" class="action-btn view-btn"
    ...
    data-created_at="<?= $row['created_at'] ?>">View</a>
            |
            <a href="edit_savingsAccount.php?id=<?= $row['account_id'] ?>" class="edit-btn">Edit</a> |
            <a href="delete_savingsAccount.php?account_id=<?= $row['account_id'] ?>"
    ...
    <a href="add_savingsAccount.php" class="login-btn">Add New Account</a>
