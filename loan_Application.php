...
$sql = "SELECT loan_application_id, member_id, loan_type_id, amount_requested, term_months, application_date, status, notes FROM LOAN_APPLICATION";
...
<main class="main-content">
  ...
  <div id="viewModal" class="modal">
    <div class="modal-content">
      ...
      <p><strong>Member ID:</strong> <span id="v-member"></span></p>
      <p><strong>Loan Type ID:</strong> <span id="v-type"></span></p>
      <p><strong>Amount Requested:</strong> ₱<span id="v-amount"></span></p>
      <p><strong>Term (months):</strong> <span id="v-term"></span></p>
      <p><strong>Application Date:</strong> <span id="v-date"></span></p>
      <p><strong>Status:</strong> <span id="v-status"></span></p>
      <p><strong>Notes:</strong> <span id="v-notes"></span></p>
    </div>
  </div>
